...
public class OrganizerCreateEventLocation extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_organizer_create_event_location);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        final Button organizer_create_event_location_button = (Button) findViewById(R.id.organiser_create_event_location_set_location_button);
        ...
        organizer_create_event_location_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent openNextActivityIntent = new Intent(OrganizerCreateEventLocation.this, EventDetailsActivity.class);
